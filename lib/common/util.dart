...
class Util {
  ...
  static DateTime getBeforeDateTime(
    ...
    DateTime beforeDate = date.subtract(new Duration(
        days: days, hours: hours, minutes: minutes, seconds: seconds));
    return beforeDate;
  }

  static DateTime getAfterDateTime(
      {DateTime? date,
      int days = 0,
      int hours = 0,
      int minutes = 0,
    ...
    DateTime afterDate = date.add(new Duration(
        days: days, hours: hours, minutes: minutes, seconds: seconds));
    return afterDate;
  }
}
